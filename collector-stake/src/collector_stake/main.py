...
logging.basicConfig(
    level=logging.INFO,
    format='{"timestamp": "%(asctime)s", "service": "collector-stake", "level": "%(levelname)s", "message": "%(message)s"}'
)
...
class StakeCollector:
    def __init__(self):
        self.book_name = os.getenv("BOOK_NAME", "stake")
