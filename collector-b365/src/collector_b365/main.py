...
logging.basicConfig(
    level=logging.INFO,
    format='{"timestamp": "%(asctime)s", "service": "collector-b365", "level": "%(levelname)s", "message": "%(message)s"}',
)
...
class Bet365Collector:
    def __init__(self):
        self.book_name = os.getenv("BOOK_NAME", "bet365")
